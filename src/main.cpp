      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          // j[1] is the data JSON object
            ...
            for (int i=0; i<sensor_fusion.size(); i++) {
              ...
              if ((d < 2+4*lane+2) && d > (2+4*lane-2)){
                ...
                if ((check_car_s > car_s) && ((check_car_s-car_s) < 40)){
                  ...
                  // Do some logic here, lower reference velocity so we don't crahs into the car infront of us, could
                  // also flag to try to change lanes.
                  //ref_vel = 29.5; //mph
                  too_close = true;
                }
              }
              // look in cars on left lane
              if (lane > 0) {
              ...
              // look on cars on the right lane
              if (lane < 2) {
                if ((d < 2+4*(lane+1)+2) && d > (2+4*(lane+1)-2))  {
                  //cout << "d: " << d << endl;
                  //cout << "Test" << endl;
            ...
            /*if ((too_close == true) && (left_free == true)) {
              lane -= 1;
            }
            else if ((too_close == true) && (right_free == true)) {
              lane -= 1;
            }*/
            ...
            // Later we will interpolate these waypoints with a spline and fill it in with more points that control TK_SPLINE_H
